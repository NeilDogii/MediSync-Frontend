      ...
      <div className="mb-8">
        <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-r from-[#0F4C81] via-[#0B6CB8] to-[#38BDF8] p-8 shadow-xl">
          <div className="relative z-10">
            ...
            <h1 className="text-4xl font-bold text-white">Doctor Management</h1>

            <p className="text-blue-100 mt-2">
              Manage doctor accounts, monitor availability and control access.
            </p>
          </div>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold">Registered Doctors</h2>

              <p className="text-sm text-slate-500">
                Click any doctor to view details
              </p>
            </div>
          </div>
